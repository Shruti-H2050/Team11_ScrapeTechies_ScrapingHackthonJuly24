...
public class FilterCriteria {
	...
	private List<String> allergiesFood = new ArrayList<>();
	
	
	public List<String> getAllergiesFood() {
		return allergiesFood;
	}


	public void setAllergiesFood(List<String> allergiesFood) {
